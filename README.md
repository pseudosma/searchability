# Searchability ![build](https://img.shields.io/travis/com/pseudosma/searchability) ![coverage](https://img.shields.io/coveralls/github/pseudosma/searchability) ![license](https://img.shields.io/npm/l/searchability)
